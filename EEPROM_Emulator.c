...
int32_t EEPROM_Init( const EEPROM_Configuration * Configuration, const EEPROM_Driver * Driver, uint8_t * Cache )
{
  int32_t RetValue;
...
{
  if ( EEPROM_VIRGIN == EEPROM_Init( &Configuration, &STM32F10X_EE_Driver, EEPROM_Cache ) )
